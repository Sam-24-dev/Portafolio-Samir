    ...
    <section className="relative -mt-10 pb-8 md:-mt-14 md:pb-12">
      <div className="container-custom px-6 md:px-12 lg:px-24">
        <motion.div
          ...
          className="rounded-[28px] border bg-primary-light/85 shadow-2xl shadow-black/10 backdrop-blur-xl dark:border-primary-lighter/70 dark:bg-primary-light/85 light:border-lightMode-border light:bg-lightMode-surface/95"
        >
          <div className="px-5 py-7 sm:px-6 md:px-8 md:py-8">
            <div className="mb-6 max-w-2xl md:mb-8">
              <p className="mb-2 text-sm font-semibold uppercase tracking-[0.22em] text-accent-cyan">
                {t.proofStrip.title}
              </p>
            ...
            <div className="grid items-stretch gap-4 sm:grid-cols-2 xl:grid-cols-4">
              {t.proofStrip.items.map((item) => (
                ...
                >
                  ...
                  <p className="mb-2 text-xs font-semibold uppercase tracking-[0.14em] text-accent-cyan sm:text-sm">
                    {item.label}
                  </p>
