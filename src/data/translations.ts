export const translations = {
  en: {
    ...
    footer: {
      ...
      github: 'GitHub',
      contact: 'Contact',
      builtWith: 'Built with React, TypeScript, Tailwind CSS, and Vercel',
  ...
  es: {
    ...
    hero: {
      ...
      trustSignals: [
        'Estudiante de 7mo semestre de Computacion',
        'Ruta Data Analyst',
        'Guayaquil, Ecuador',
        'Abierto a oportunidades remotas o hibridas',
      ],
      subtitle:
    ...
    footer: {
      ...
      github: 'GitHub',
      contact: 'Contacto',
      builtWith: 'Construido con React, TypeScript, Tailwind CSS y Vercel',
