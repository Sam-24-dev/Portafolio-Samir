...
export const projects: Project[] = [
  {
    ...
    descriptionEs:
      'Caso de analitica de clientes que convierte registros de marketing en segmentos confiables y una vista ejecutiva en Power BI para apoyar decisiones.',
    highlights: [
    ...
    highlightsEs: [
      '2,021 registros de clientes preparados para analisis',
      'Segmentacion de alto valor confiable para lectura de negocio',
      'Flujo reproducible de limpieza y validacion en Python',
      'Reporte ejecutivo en Power BI con layouts moviles',
    ],
    dashboardUrl:
  ...
  },
  {
    ...
    descriptionEs:
      'Producto analitico que combina datos competitivos, contexto de rendimiento y proyecciones de jugadores para apoyar decisiones en eSports LATAM.',
    highlights: [
    ...
    highlightsEs: [
      ...
      'Proyecciones de jugadores para planificacion 2026',
  ...
  },
  {
    ...
    descriptionEs:
      'Dashboard comercial en Power BI disenado para mostrar brechas de desempeno, categorias lideres y oportunidades de mercado con lectura ejecutiva inmediata.',
    highlights: [
    ...
    highlightsEs: [
      ...
      '$80.05K en la categoria con mayor ingreso identificada',
      'Tulsa aparecio como el mercado mas fuerte',
    ],
    dashboardUrl:
  ...
  },
  {
    ...
    descriptionEs:
      'Proyecto de analitica operativa que conecta ETL, seguimiento de KPIs y recuperacion de rentabilidad en un flujo agricola respaldado por dashboards.',
    highlights: [
    ...
    supportingValueEs:
      'Refuerza ejecucion ETL operativa, diseno de KPIs y una narrativa clara de recuperacion de rentabilidad.',
  ...
  },
  {
    ...
    descriptionEs:
      'Estudio estadistico aplicado que modela la precision del saque en ping pong y valida el resultado con una metodologia reproducible.',
    highlights: [
    ...
    highlightsEs: [
      ...
      'Resultado de correlacion debil con r = 0.049',
    ],
    supportingLabel: 'Statistical validation',
    supportingLabelEs: 'Validacion estadistica',
    supportingValue: 'Reinforces experimental design, model validation, and reproducible communication of findings.',
    supportingValueEs:
      'Refuerza diseno experimental, validacion de modelos y comunicacion reproducible de hallazgos.',
  ...
  },
  {
    ...
    descriptionEs:
      'MVP de hackathon que convierte senales climaticas historicas en una experiencia interactiva para apoyar decisiones de planificacion.',
    highlights: [
    ...
    supportingLabelEs: 'Ejecucion rapida de producto',
    supportingValue: 'Reinforces rapid prototyping, cross-functional collaboration, and functional delivery under time pressure.',
    supportingValueEs:
      'Refuerza prototipado rapido, colaboracion multidisciplinaria y entrega funcional bajo presion de tiempo.',
